...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><a href="pages/diagnosa.php"><button type="button" class="btn btn-primary btn-block">DIAGNOSA PENYAKIT</button></a></p>
      <p><a href="pages/daftarpenyakit.php"><button type="button" class="btn btn-primary btn-block">DAFTAR PENYAKIT</button></a></p>
      <p><a href="pages/about.php"><button type="button" class="btn btn-primary btn-block">ABOUT</button></a></p>
